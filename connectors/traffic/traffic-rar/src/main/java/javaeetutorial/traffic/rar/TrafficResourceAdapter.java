...
@Connector(displayName = "TrafficRA", vendorName = "Java EE Tutorial", version = "7.0")
public class TrafficResourceAdapter implements ResourceAdapter, Serializable {
	...
	public void start(BootstrapContext ctx) throws ResourceAdapterInternalException {
		...
		/*
		 * Get the work manager from the container to submit tasks to be
		 * executed in container-managed threads
		 */
	...
	public void endpointActivation(MessageEndpointFactory endpointFactory, ActivationSpec spec)
		...
		/*
		 * New in JCA 1.7 - Get the endpoint class implementation (i.e. the MDB
		 * class). This allows looking at the MDB implementation for
		 * annotations.
		 */
		 ...
		 * but we need to do that in a different thread, otherwise the MDB never
		 * deploys.
		 */
