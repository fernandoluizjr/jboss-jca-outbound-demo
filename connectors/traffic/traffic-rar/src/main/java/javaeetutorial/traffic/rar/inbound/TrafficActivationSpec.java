...
@Activation(messageListeners = { TrafficListener.class })
public class TrafficActivationSpec implements ActivationSpec, Serializable {
	...
	/*
	 * Inspect the MDB class for methods with a custom annotation. This allows
	 * the MDB business interface to be emtpy
	 */
	...
	/*
	 * Used by the subscriber thread to invoke the discovered commands on the
	 * MDB
	 */
